...
def update_parameters_with_momentum(parameters, grads, v, beta, learning_rate):
    ...
    # Common values for  ββ  range from 0.8 to 0.999. If you don't feel inclined to tune this,
    # β=0.9β=0.9  is often a reasonable default.
...
if __name__ == '__main__':
    ...
    # 3 layer model with Gradient descent
